...
<head>
    ...
    <title>About Us | Nofino Rural Finance Private Limited </title>
    <!-- favicons Icons -->
...
<body>
    ...
    <?php include ('pages/header.php'); ?>
        ...
        <section class="about-three">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="about-three__image">
                            <img src="assets/images/about_us/Finance_re_gnv2.jpg" alt="">
                            <div class="about-three__image-text">Nofino Rural FINANCE</div>
                ...
                <div class="row">
                    ...
                    <!-- /.col-lg-5 -->
                    <div class="col-lg-7">
                        <p class="block-text">About our pylon company to provide loan to customers dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris
                            nisi ut aliquip ex ea commodo consequat lorem provide more more funds to bank and small middle company.</p>
                        <!-- /.block-text -->
                    </div>
                    <!-- /.col-lg-7 -->
                </div>
        ...
        <section class="funfact-one">
            <div class="funfact-one__bg" style="background-image: url(assets/images/backgrounds/funfact-bg-1-1.jpg);"></div>
            <!-- /.funfact-one__bg -->
            <div class="container">
                <div class="row">
