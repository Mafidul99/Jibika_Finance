...
<head>
    ...
    <title>Home | Nofino Rural Finance Private Limited </title>
    <!-- favicons Icons -->
...
<body>
    <div class="preloader">
        <img class="preloader__image" src="assets/images/loader.svg" alt="Loader">
    </div>
    <!-- /.preloader -->
    <div class="page-wrapper">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-6 col-lg-6">
                                    ...
                                    <h2>Connecting Your Loan Needs
                                    </h2>
                                    <a href="common/loans_apply/index.php" class=" thm-btn">Apply For Loan</a>
                ...
                <div class="row">
                    <div class="col-lg-12 col-xl-7">
                        <div class="about-one__content">
                            ...
                            <!-- /.block-title -->
                            <p>There are many variations of passages of lorem ipsum available the majority have suffered alteration in some form by injected humour. Duis aute irure dolor lipsum is simply free text available in the local markets in reprehenderit.Nam
                                aliquam sem et tortor consequat mattis pellentesque semper tailored for specific uses and specific market segment.</p>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="feature-four__box text-left">
                                    ...
                                    <div class="feature-four__box-inner">
                                        ...
                                        <div class="feature-four__box-icon"><i class="flaticon flaticon-property-1"></i>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="feature-four__box text-left">
                                    <!-- .feature-four__box -->
                                    <div class="feature-four__box-inner">
                                        <div class="feature-four__box-icon"><i class="flaticon flaticon-growth-1"></i>
                                        </div>
                                        <div class="feature-four__box-right">
                                            <h3>
                                                Certified Company
                    ...
                    <div class="col-lg-12 col-xl-5">
                        <form action="#" id="loan-calculator" class="about-one__form wow fadeInUp" data-wow-duration="1500ms">
                            ...
                            <div class="about-one__form-content">
                                ...
                                <!-- /.input-box__top -->
                                <div class="input-box">
                                    <div class="range-slider-interest" id="range-slider-interest"></div>
                                    <input type="hidden" value="" id="min-value-rangeslider-interest">
                                    <input type="hidden" value="" id="max-value-rangeslider-interest">
                                </div>
                                <!-- /.input-box -->
                                <p>
                    ...
                    <div class="col-lg-4">
                        <div class="service-one__card">
                            ...
                            <div class="service-one__content">
                                ...
                                <p>There are many variations of passages of lorem ipsum available the majority have some.
                                </p>
                                <a href="loans-details.php" class="pylon-icon-right-arrow service-one__link"></a>
                                <!-- /.service-one__link -->
                            </div>
        ...
        <section class="feature-one">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <!-- /.col-lg-6 -->
                    <div class="col-lg-6">
                        <p class="block-text">Turpis cursus in hac habitasse platea dictumst quisque. Aenean euismod elementum nisi quis eleifend quam adipiscing vitae proin.There of available but the majority have suffered alteration in some form, by injected humou or randomised
                            words which don’t look even slightly believable.Nam aliquam sem et tortor consequat at urna mattis pellentesque..</p>
                        <!-- /.block-text -->
                    </div>
                    <!-- /.col-lg-6 -->
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="feature-one__box">
                            ...
                            <p>Flexible with Your Repayments
                            </p>
                        </div>
                        <!-- /.feature-one__box -->
                    </div>
        ...
        <section class="trusted-company">
            <div class="trusted-company__bg" style="background-image: url(assets/images/shapes/trust-bg-1-1.png);">
            </div>
            <!-- /.trusted-company__bg -->
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="trusted-company__content">
                            ...
                            <div class="trusted-company__image">
                                <img src="assets/images/resources/trust-1-1.png" alt="" height="148" width="171">
                                <p>There are many variations of passages of lorem ipsum available the majority have suffered alteration in some form by injected humour. Duis aute irure dolor lipsum is simply in voluptate velit esse cillum dolore eu fugiat
                                    nulla pariatur.</p>
                            </div>
                                ...
                                <div class="col-sm-5 col-xs-12">
                                    <ul class="trusted-company__list">
                                        <li class="trusted-company__list-item">
                                            ...
                                            <span class="trusted-company__list-text">Individual Loan</span>
                                        </li>
                                        <li class="trusted-company__list-item">
                                            <span>
                                                <i aria-hidden="true" class="far fa-check-circle"></i>
                                            </span>
                                            <span class="trusted-company__list-text">Product Loan</span>
                                        </li>
                                        <li class="trusted-company__list-item">
                                            <span>
                                                <i aria-hidden="true" class="far fa-check-circle"></i>
                                            </span>
                                            <span class="trusted-company__list-text">Group Loan</span>
                                        </li>
                                    </ul>
                                </div>
                                <!-- /.col-md-5-->
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="testimonials-one__box">
                                <p><span>I was very impresed by the company service lore ipsum is simply free text used
                                        by copy typing refreshing. Neque porro est dolorem ipsum quia.</span></p>
        ...
        <section class="funfact-one">
            <div class="funfact-one__bg" style="background-image: url(assets/images/backgrounds/funfact-bg-1-1.jpg);">
            </div>
            <!-- /.funfact-one__bg -->
            <div class="container">
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="why-choose__content">
                            ...
                            <!-- /.block-title -->
                            <p>Provide your best loan services and our experience staff help you. Less document and fast approve process of passages. Also we are providing credit card facility to per day interest credit card lorem Ipsum available, but the
