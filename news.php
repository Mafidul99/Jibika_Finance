...
<head>
    ...
    <title>News | Nofino Rural Finance Private Limited </title>
    <!-- favicons Icons -->
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-card">
                            ...
                            <div class="blog-card__content">
                                ...
                                <!-- /.blog-card__meta -->
                                <h3><a href="news-details.html">How find low interest rate for home loan</a></h3>
                                <div class="blog-card__bottom">
                                    <div class="blog-card-bottom-readmore">
                                        <a href="news-details.html" class="readmore-card-link"><i class="pylon-icon-right-arrow"></i>Read More</a>
                                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-card">
                            ...
                            <div class="blog-card__content">
                                ...
                                <!-- /.blog-card__meta -->
                                <h3><a href="news-details.html">10 financial essential advice before taking loan</a></h3>
                                <div class="blog-card__bottom">
                                    <div class="blog-card-bottom-readmore">
                                        <a href="news-details.html" class="readmore-card-link"><i class="pylon-icon-right-arrow"></i>Read More</a>
                                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-card">
                            ...
                            <div class="blog-card__content">
                                ...
                                <!-- /.blog-card__meta -->
                                <h3><a href="news-details.html">Are you still planning for mortgage loan ?</a></h3>
                                <div class="blog-card__bottom">
                                    <div class="blog-card-bottom-readmore">
                                        <a href="news-details.html" class="readmore-card-link"><i class="pylon-icon-right-arrow"></i>Read More</a>
                                    </div>
